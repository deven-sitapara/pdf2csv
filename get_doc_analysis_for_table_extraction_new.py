...
class getDocumentAnalysisResult:
    ...
    textract = ""
    def __init__(self,jobId, file_name, region_name):
        self.jobId = jobId
    ...
    def GetResults(self):
        ...
        while finished == False:
            ...
            if paginationToken == None:
                response = self.textract.get_document_analysis(JobId=self.jobId, MaxResults=maxResults)
            else:
                response = self.textract.get_document_analysis(JobId=self.jobId, MaxResults=maxResults,
...
def main():
    ...
    x, x, region_name, x = load_aws_config()
    
    result = getDocumentAnalysisResult(jobId, file_name, region_name)
    response_blocks = result.GetResults()
